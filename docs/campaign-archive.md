...
Each `#campaign/scene/…` reader shows full original messages, groups adjacent posts by the same contributor, and retains each post's timestamp, edit marker, images and reply link. Asides and formal filings break contributor groups. Previous/next navigation, a scene selector, and a return link avoid scrolling through the entire archive. Titles and short summaries are explicitly labeled editorial; none replace original text.
