...
The Brother workshop is unchanged. Its function block, existing stylesheet, character model, PDF generator, and committed blank PDF remain byte-for-byte identical to the previous release.
