...
export const defaults = () => ({name:'',player:'',subclass:'Sawbones',level:1,companyUnit:'',pronouns:'',trait:'',trait2:'',quirk:'',traitChoices:'',save1:'Strength',save2:'Constitution',extraSaves:'',skills:[],tools:'',languages:'Khato, Black Cant',strength:10,dexterity:10,constitution:10,intelligence:10,wisdom:10,charisma:10,hpMax:'',hpCurrent:'',hpTemp:'',ac:'',speed:30,initiative:'',hitDice:'',luck:'',chips:'',gold:200,secondWind:'',actionSurge:'',indomitable:'',resources:'',weapons:'',armor:'',equipment:'',magicItems:'',notes:'',history:'',allies:'',featureNotes:'',deathSuccesses:0,deathFailures:0});
